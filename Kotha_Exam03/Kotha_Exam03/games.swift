...
let games:[Game] = [badminton,basketball,tableTennis,volleyball,chess,snooker,swimming,boxing,karate,handball,soccer,cricket,tennis,hockey,golf,trackandField,cycling,rugby,surfing]
